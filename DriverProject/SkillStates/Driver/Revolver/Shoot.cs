...
namespace RobDriver.SkillStates.Driver.Revolver
{
    public class Shoot : BaseSkillState
    {
        ...
        public static GameObject tracerEffectPrefab = Modules.Assets.shotgunTracer;
        public static GameObject critTracerEffectPrefab = Modules.Assets.shotgunTracerCrit;
        ...
        private void Fire()
        {
            ...
            if (base.isAuthority)
            {
                ...
                if (this.isCrit)
                {
                    // this is where ricochet would go
                }
            }
        }
        ...
        public override InterruptPriority GetMinimumInterruptPriority()
        {
            ...
            if (this.isCrit && !this.hasFired) return InterruptPriority.PrioritySkill;
