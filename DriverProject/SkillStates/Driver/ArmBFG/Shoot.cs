        ...
        public virtual void Fire()
        {
            if (!this.hasFired)
            {
                ...
                if (base.isAuthority)
                {
                    ...
                    ProjectileManager.instance.FireProjectile(Modules.Projectiles.plasmaCannonProjectilePrefab, aimRay.origin, Util.QuaternionSafeLookRotation(aimRay.direction), this.gameObject, this.damageStat * this._damageCoefficient, 1200f, this.isCrit, DamageColorIndex.Default, null, 120f);
                }
            }
        }
